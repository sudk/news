	...
	$.fn.lightTreeview=function(s1) {
		...
		if(settings.collapse) {	//允许伸缩
			...
			$(".treeview-file").click(function() {
				$("#JQtree").find('div').removeClass("colOrange");
				$("#JQtree").find('div').removeClass("colBold");
				$("#JQtree").find('li').removeClass("colOrange");
				$("#JQtree").find('li').removeClass("colBold");
				$(this).addClass("colOrange");	
				$(this).addClass("colBold");
			});				
			...
			$(node).find('div').click(function() {
				...
				$("#JQtree").find('div').removeClass("colOrange");
				$("#JQtree").find('div').removeClass("colBold");
				$(this).parent('li').parent('ul').prev(".treeview-folder").addClass("colOrange");	
				$(this).parent('li').parent('ul').prev(".treeview-folder").addClass("colBold");
				$(this).parent('li').parent('ul').parent('li').parent('ul').prev(".treeview-folder").addClass("colOrange");	
				$(this).parent('li').parent('ul').parent('li').parent('ul').prev(".treeview-folder").addClass("colBold");				
				$(this).addClass("colOrange");	
				$(this).addClass("colBold");				
			});
